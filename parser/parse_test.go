...
var recordTestMap = map[string]Record{
	...
	`[21:23:38.818] [@Zangyef#686674938948221|(4613.04,4821.58,698.01,168.25)|(1/326800)] [] [] [DisciplineChanged {836045448953665}: Powertech {16141007401395916385}/Shield Tech {2031339142381604}]`:                                                                                                                                     {Actor: Actor{Name: "Zangyef", ID: "686674938948221"}, Effect: Effect{Event: "DisciplineChanged", EventID: "836045448953665", Action: "Powertech", ActionID: "16141007401395916385"}},
}
